    ...
    <div className="md:px-10 px-7 my-10" id="contact">
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-1/2">
          <h1 className="text-primary font-semibold text-3xl mt-16">Connect with me:</h1>
          <p className="my-3 text-white md:w-3/4 leading-[2]"></p>
          {/* social icons */}
          <div className="flex ">
        ...
        {/* form */}
        <div className="md:w-1/2">
          <p className="mt-16 text-white text-2xl mb-6">Hubungi saya, mari kita buat keajaiban bersama</p>
          <form>
            ...
            <button className="btn transition-all duration-500 bg-primary py-2 px-12 rounded text-white hover:bg-white hover:text-primary block">Send</button>
          </form>
        </div>
      </div>
    </div>
